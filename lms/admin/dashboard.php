       ...
       <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                ...
                <?php $query33=mysqli_query($con,"Select * from tbllaundryreq");
$trequests=mysqli_num_rows($query33);
?>
                <div class="mr-5"><?php echo $trequests;?> Total Requests</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="all-requests.php" target="_blank">
...
?>
              ...
              <a class="card-footer text-white clearfix small z-1" href="new-request.php" target="_blank">
                <span class="float-left">View Details</span>
                <span class="float-right">
...
?>
              ...
              <a class="card-footer text-white clearfix small z-1" href="accept-request.php" target="_blank">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-fw fa-list"></i>
                </span>
...
?>
              ...
              <a class="card-footer text-white clearfix small z-1" href="inprocess-request.php" target="_blank">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-fw fa-list"></i>
                </span>
...
?>
              ...
              <a class="card-footer text-white clearfix small z-1" href="finish-request.php" target="_blank">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-fw fa-list"></i>
                </span>
  ...
  <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              <div class="card-body">
                ...
                <?php $query22=mysqli_query($con,"Select * from tbluser");
$regusers=mysqli_num_rows($query22);
?>
                <div class="mr-5"><?php echo $regusers;?> Registered Users</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="user-detail.php" target="_blank">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-fw fa-list"></i>
                </span>
...
<tr>
  ...
  <tr>
    <th>Curatin Laundry Price</th>
    <td><?php  echo $row['Curtains'];?></td>
  </tr>

  <tr>
    <th>pillowcover & Bedsheet Laundry Price</th>
    <td><?php  echo $row['Bedsheets'];?></td>
  </tr>
