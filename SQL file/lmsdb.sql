...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2023 at 10:32 AM
...
CREATE TABLE `tbllaundryreq` (
  ...
  `Jeans` varchar(120) DEFAULT NULL,
  `Curtains` varchar(120) DEFAULT NULL,
  `Bedsheets` varchar(120) DEFAULT NULL,
...
INSERT INTO `tbllaundryreq` (`ID`, `UserID`, `DateofLaundry`, `TopWear`, `BottomWear`, `WoolenCloth`, `Jeans`, `Curtains`, `Bedsheets`, `Other`, `Service`, `PickupAddress`, `ContactPerson`, `Description`, `Status`, `Othercharges`, `postingDate`, `PaymentType`) VALUES
(1, 1, '2023-08-20', '7', '5', '8', '2', '3','1', '10', 'pickupservice', 'A 123 XYZ Apartment New Delhi 110092', 'Rahul', 'NA', '1', 200, '2023-08-16 07:53:36', 'Cash on Delivery'),
(2, 2, '2023-08-30', '5', '6', '10', '1', '4', '2', '4', 'dropservice', '', 'Amit', 'NA', '3', 745, '2023-08-16 11:46:18', 'Cash on Delivery');
...
INSERT INTO `tblpricelist` (`Id`, `TopWear`, `BottomWear`, `Woolen`, `Jeans`,`Curtains`,`Bedsheets`) VALUES
(1, '14', '22', '20', '25','36','50');
